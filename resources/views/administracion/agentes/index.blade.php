...
@section('content')
    <p>lista de Usuarios agentes que usan la plataforma</p>
    <a href="{{ url('admin/agentes/registrar') }}">
    ...
    <div class="table-responsive">
    	...
    	<table class="table table-hover table-bordered  bg-white">
		    ...
		    <tr>
				...
				<td>
					<!--Ver-->
					<a href="{{ url('admin/agentes/ver/'.$user->id) }}">
						<button type="button d-inline" class="btn btn-info btn-xs"><small>Ver</small></button></a>
					</a>
					<!--Editar-->
					<a href="{{ url('admin/agentes/editar/'.$user->id) }}">
						<button type="button d-inline" class="btn btn-default btn-xs"><small>Editar</small></button></a>
					</a>
					<!--Eliminar-->
					<form method="post" class="d-inline" action="{{ url('admin/agentes/eliminar/'.$user->id)}}" onsubmit="return confirm('Confirma que desea eliminar el elemento?');">
						@csrf
